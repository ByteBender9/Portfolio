...
const projects = {
  dochat: {
    ...
    description:
      "A modern real-time chat application with channels, persistent messaging, responsive design, and a clean user experience.",
  ...
  lipvision: {
    ...
    description:
      "An AI-powered lip reading system built using deep learning, OpenCV, MediaPipe, and TensorFlow.",
  ...
  jarvis: {
    ...
    description:
      "A desktop voice assistant capable of voice commands, automation, and face authentication.",
  ...
  cyberbullying: {
    ...
    description:
      "A machine learning web application that detects cyberbullying using NLP and text classification.",
